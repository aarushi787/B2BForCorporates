    ...
    return (
      <div className="space-y-8 pb-12 animate-in fade-in slide-in-from-right-4 duration-500">
        <button 
          ...
          className="flex items-center gap-2 text-sm font-black text-gray-500 hover:text-[#057D97] transition-colors"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-8">
            <div className="bg-white border border-gray-100 rounded-[3rem] overflow-hidden shadow-sm">
              <div className="h-48 bg-gradient-to-r from-[#0690AE] to-[#057D97] p-12 flex items-end relative">
                ...
                <div className="w-32 h-32 bg-white rounded-[2.5rem] shadow-2xl flex items-center justify-center text-[#057D97] font-black text-5xl border-4 border-white translate-y-16">
              ...
              <div className="p-12 pt-24">
                <div className="flex justify-between items-start mb-8">
                  ...
                  <div className="text-right">
                    <div className="flex items-center gap-2 text-[#0690AE] font-black text-2xl mb-1">
                ...
                <div className="grid grid-cols-3 gap-6 mb-12">
                  ...
                  <div className="p-6 bg-gray-50 rounded-3xl">
                    ...
                    <p className="text-xl font-black text-[#057D97]">{selectedCompany.dealCompletionRate}%</p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-3 mb-12">
                  {selectedCompany.capabilities.map(cap => (
                    <div key={cap} className="px-5 py-3 bg-[#E6F6FA] text-[#057D97] rounded-2xl text-xs font-black uppercase tracking-widest border border-[#CDEEF5]">
                      {cap}
                    </div>
                  ))}
                </div>

                <div className="p-10 bg-[#0690AE] rounded-[2.5rem] text-white shadow-xl shadow-[#CDEEF5]">
                  <h3 className="text-2xl font-black mb-4">Partner with {selectedCompany.name}</h3>
                  <p className="text-[#CDEEF5] mb-8 font-medium">Verified partners utilize the Nexus Escrow & Contract system to ensure 100% project success and financial safety.</p>
                  <button 
                    onClick={() => setShowRequestPresentation(true)}
                    className="w-full py-5 bg-white text-[#057D97] font-black rounded-2xl hover:bg-[#E6F6FA] transition-all shadow-xl shadow-[#034E5E]/20 flex items-center justify-center gap-2"
                  >
          ...
          <div className="space-y-8">
            <div className="bg-white p-10 rounded-[2.5rem] border border-gray-100 shadow-sm">
              <div className="flex items-center gap-3 mb-8">
                <div className="w-12 h-12 bg-[#E6F6FA] text-[#057D97] rounded-2xl flex items-center justify-center">
                  <ShieldCheck size={24} />
                </div>
                <div>
                ...
                {verifiedBenefits.map((benefit, i) => (
                  <div key={i} className="group">
                    <div className="flex items-start gap-4">
                      <div className="mt-1">
                        <CheckCircle2 size={16} className="text-[#057D97]" />
                      </div>
                      <div>
              ...
              <div className="space-y-6">
                 ...
                 {requestSent ? (
                   ...
                   <button 
                    ...
                    className="w-full py-5 bg-[#0690AE] text-white font-black rounded-2xl shadow-xl shadow-[#CDEEF5] hover:bg-[#057D97] transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                   >
                ...
                <div className="flex flex-wrap gap-2">
                  {savedFilters.map(sf => (
                    <button 
                      ...
                      className="px-3 py-1 bg-[#E6F6FA] text-[#057D97] rounded-lg text-[10px] font-black border border-[#CDEEF5] hover:bg-[#CDEEF5]"
                    >
                      {sf.name}
                    </button>
                  ))}
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-gray-50">
                ...
                <input 
                  ...
                  className="w-full h-1.5 bg-gray-100 rounded-full appearance-none accent-[#0690AE]"
                />
              </div>
        ...
        <div className="flex-1 min-w-0 space-y-6">
          <div className="relative group">
            ...
            <input 
              ...
              className="w-full pl-16 pr-4 py-5 bg-white border border-gray-200 rounded-[2rem] shadow-sm focus:ring-4 focus:ring-[#0690AE]/10 outline-none transition-all font-medium"
              value={searchQuery}
            ...
            {filteredCompanies.map(company => (
              <div key={company.id} className="bg-white border border-gray-100 rounded-[2.5rem] overflow-hidden hover:shadow-2xl transition-all group flex flex-col relative">
                {company.verified && (
                  ...
                  >
                    <div className="bg-[#0690AE] text-white px-3 py-1.5 rounded-2xl shadow-xl border border-white/20 flex items-center gap-1.5 backdrop-blur-md">
                ...
                <div className="h-32 bg-gradient-to-br from-[#0690AE] via-[#057D97] to-[#046A80] relative">
                  <div className="absolute -bottom-10 left-10 w-24 h-24 bg-white rounded-[2rem] shadow-2xl border-4 border-white flex items-center justify-center text-[#057D97] font-black text-4xl overflow-hidden">
                ...
                <div className="p-10 pt-16 flex-1 flex flex-col">
                  <div className="flex items-start justify-between">
                    <div>
                      <h3 className="text-2xl font-black text-gray-900 leading-tight group-hover:text-[#057D97] transition-colors flex items-center gap-2 mb-1">
                        {company.name}
                      </h3>
                    ...
                    <div className="flex items-center text-[#0690AE] gap-1.5 bg-[#E6F6FA] px-4 py-2 rounded-2xl border border-[#CDEEF5]">
                  ...
                  <div className="mt-8 flex gap-4">
                    <div className="flex-1 p-5 bg-gray-50 rounded-[1.5rem] border border-gray-100">
                      ...
                      <span className="text-xs font-black text-[#057D97]">{company.complianceScore}% Score</span>
                    </div>
                    <div className="flex-1 p-5 bg-gray-50 rounded-[1.5rem] border border-gray-100">
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-100 flex items-center justify-between">
                    ...
                    <button 
                      ...
                      className="flex items-center gap-2 text-[#057D97] font-black text-sm hover:translate-x-2 transition-all group/btn"
                    >
          ...
          {filteredCompanies.length === 0 && (
            <div className="py-24 text-center">
              ...
              <button 
                ...
                className="mt-10 px-10 py-4 bg-[#0690AE] text-white font-black rounded-2xl shadow-xl"
              >
                Reset All Filters
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-gray-900/80 backdrop-blur-md">
          <div className="bg-white w-full max-w-sm rounded-3xl p-8 animate-in zoom-in duration-300">
            ...
            <input 
              ...
              className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl mb-6 outline-none focus:ring-2 focus:ring-[#0690AE] text-sm"
              value={newFilterName}
            ...
            <div className="flex gap-3">
              ...
              <button onClick={saveFilter} className="flex-1 py-3 bg-[#0690AE] text-white font-bold rounded-xl text-sm shadow-lg">Save View</button>
            </div>
          </div>
        </div>
      )}
